class Talking extends Phaser.Scene {
    ...
    init() {
        ...
        this.DBOX_FONT = 'sample_font'	    // dialog box font key
        ...
        this.LETTER_TIMER = 5		    // # ms each letter takes to "type" onscreen
    ...
    create() {
        ...
        this.sasuke = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'sasuke').setOrigin(0, 1)
